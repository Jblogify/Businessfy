        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/projects" className="text-green-100 hover:text-white">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/news" className="text-green-100 hover:text-white">
                  News
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/construction" className="text-green-100 hover:text-white">
                  Construction
                </Link>
              </li>
              <li>
                <Link href="/services/engineering" className="text-green-100 hover:text-white">
                  Engineering
                </Link>
              </li>
              <li>
                <Link href="/services/project-management" className="text-green-100 hover:text-white">
                  Project Management
                </Link>
              </li>
              <li>
                <Link href="/services/consulting" className="text-green-100 hover:text-white">
                  Consulting
                </Link>
              </li>
              <li>
                <Link href="/services/maintenance" className="text-green-100 hover:text-white">
                  Maintenance
                </Link>
              </li>
            </ul>
