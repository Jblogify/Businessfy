...
export function CreateFolderDialog({ isOpen, onClose, onCreateFolder, existingFolders }: CreateFolderDialogProps) {
  ...
  const handleCreateFolder = () => {
    ...
    if (existingFolders.includes(folderName.trim())) {
      toast({
        ...
        description: `A folder named "${folderName.trim()}" already exists`,
        variant: "destructive",
      })
      return
    }
